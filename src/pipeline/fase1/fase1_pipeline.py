...
def _build_parser():
    ...
    parser.add_argument(
        "--chest_imgs", default=None, help="Directorio con imágenes (all_images/)"
    )
    parser.add_argument(
        "--nih_train_list",
        default=None,
    ...
    parser.add_argument(
        "--isic_imgs", default=None, help="Carpeta con imágenes ISIC .jpg"
    )
    ...
    parser.add_argument("--luna_csv", default=None, help="candidates_V2.csv")
