...
|------|-------------|--------|--------|
| 0 | Prerequisites | ✅ | 0.7s |
| 1 | Descargar datasets | ✅ | 0.0s |
| 2 | Extraer archivos | ✅ | 1.3s |
| 3 | Post-procesado NIH | ✅ | 6.3s |
| 4 | Etiquetas páncreas | ✅ | 0.0s |
| 5 | Splits 80/10/10 | ✅ | 1.3s |
| 6 | ISIC Preprocesamiento | dry_run | 0.0s |
| 7 | Datos 3D | ⏭️ | — |
| 8 | DenseNet3D | ✅ | 0.0s |
| 9 | Reporte | — | — |
