...
|------|-------------|--------|--------|
| 0 | Prerequisites | ✅ | 0.6s |
| 1 | Descargar datasets | ✅ | 4890.9s |
| 2 | Extraer archivos | ✅ | 204.2s |
| 3 | Post-procesado NIH | ✅ | 4.6s |
| 4 | Etiquetas páncreas | ✅ | 0.0s |
| 5 | Splits 80/10/10 | ✅ | 17.3s |
| 6 | Datos 3D | — | 1659.8s |
| 7 | DenseNet3D | ⚠️ | 0.0s |
| 8 | Reporte | — | — |
...
- total: 4766
- total_groups: 687
- group_report: {0: {'images': 1315, 'groups': 131, 'reduction_ratio': 10.04}, 1: {'images': 2031, 'groups': 302, 'reduction_ratio': 6.73}, 2: {'images': 1420, 'groups': 254, 'reduction_ratio': 5.59}}
- similarity_threshold: 0.12
- note: Split por grupos de similitud inferidos (pseudo-patient_id). Umbral=0.12. Reducción media: 6.9 imgs/grupo.
